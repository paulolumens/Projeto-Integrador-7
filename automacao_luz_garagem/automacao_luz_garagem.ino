...
//================declaracao constatantes e variaveis=======
const char* ssid = "MAC";    //nome da rede que ira conectar
...
String getPage() {
  ...
  page += "<title>Automa&ccedil&atildeo Lumens</title>";
  ...
  page += "</head><body><h1>Lumens Automa&ccedil&atildeo</h1>";
